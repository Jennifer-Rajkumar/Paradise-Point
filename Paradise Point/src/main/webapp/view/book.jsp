...
<body>
       ...
       <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
           ...
           <li class="nav-item">
             ...
             <li class="nav-item">
              <c:if test="${pageContext.request.userPrincipal.name != null}">
                      <form id="hall" method="POST" action="${contextPath}/hall">
                           <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                      </form>
                      <a onclick="document.forms['hall'].submit()"><span class="c">Hall</span></a>                           
                </c:if>
             </li>
    ...
    <br><br>
     <!--Navigation bar ends-->
   <!--date starts-->
   <img src="https://cdn4.iconfinder.com/data/icons/small-n-flat/24/calendar-512.png" style="display: block;margin-left: auto;margin-right: auto;width: 47px;"/>
       <h2 style="text-align: center;font-family: Courgette;text-align: center;color: #afd275;">Dates Available</h2>
       <div class="container">
