   ...
   <div class="box4">
    ...
    <div class="box">
        ...
        <div class="form-group ${error != null ? 'has-error' : ''}">
            <span class="alert" style="color:white">${message}</span>
            <span class="alert" style="color:white">${error}</span>
            <div class="inputBox">
            ...
            <button class="btn" type="submit" style="color:white;background-color: rgb(255, 144, 162);width:30%;">Log In</button>
            <br>
            <h5 class="text-center">New user ?<a href="${contextPath}/registration">Sign up here </a></h5>
        </div>
      </form>
      </div>
      <div class="box3">
