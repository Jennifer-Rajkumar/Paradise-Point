...
<body>
       ...
       <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
           <ul class="nav navbar-nav navbar-right text-danger">
            <li class="nav-item"><a href="/uid-${uid}/party"><span class="c">Home</span></a></li>
            <li class="nav-item">
    ...
    <br><br>
     ...
     <div id="alert" class="alert alert-danger alert-dismissible fade in">
        ...
        <strong>Oops!</strong> Your Payment transaction failed!
      </div>
      <br>
      <div id="alert" class="alert alert-warning alert-dismissible fade in">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        Check your wallet ! and try again If error exists contact our Admin !
      </div>
      <img src="https://i.pinimg.com/originals/32/3e/3b/323e3b47f07fa1fb0a4b2ecb03b2c965.png" width="200px" height="200px" style="display: block;margin-left: auto;margin-right: auto;">
